...
TEMPLATES = [
    ...
    # ── DNS Providers ──────────────────────────────────────────────────
    {
        "id": "ns_desec",
        "name": "deSEC",
        "description": "NS records for deSEC DNS hosting",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns1.desec.io."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns2.desec.org."},
        ],
    },
    {
        "id": "ns_cloudflare",
        "name": "Cloudflare",
        "description": "NS records for Cloudflare DNS",
        "category": "DNS Providers",
        "variables": {
            "cf_ns1": {
                "label": "Cloudflare NS 1",
                "hint": "e.g. anna.ns.cloudflare.com. — assigned per account",
                "default": "",
                "required": True,
            },
            "cf_ns2": {
                "label": "Cloudflare NS 2",
                "hint": "e.g. rick.ns.cloudflare.com. — assigned per account",
                "default": "",
                "required": True,
            },
        },
    ...
    },
    {
        "id": "ns_aws_route53",
        "name": "AWS Route 53",
        "description": "NS records for AWS Route 53 hosted zone",
        "category": "DNS Providers",
        "variables": {
            "r53_ns1": {
                "label": "Route 53 NS 1",
                "hint": "From hosted zone details, e.g. ns-123.awsdns-45.com.",
                "default": "",
                "required": True,
            },
            "r53_ns2": {
                "label": "Route 53 NS 2",
                "hint": "e.g. ns-456.awsdns-78.net.",
                "default": "",
                "required": True,
            },
            "r53_ns3": {
                "label": "Route 53 NS 3",
                "hint": "e.g. ns-789.awsdns-01.org.",
                "default": "",
                "required": True,
            },
            "r53_ns4": {
                "label": "Route 53 NS 4",
                "hint": "e.g. ns-1234.awsdns-56.co.uk.",
                "default": "",
                "required": True,
            },
        },
    ...
    },
    {
        ...
        "description": "NS records for Google Cloud DNS managed zone",
        "category": "DNS Providers",
        "variables": {
            "gcp_ns1": {
                "label": "Google Cloud NS 1",
                "hint": "From Cloud DNS zone details, e.g. ns-cloud-a1.googledomains.com.",
                "default": "",
                "required": True,
            },
            "gcp_ns2": {
                "label": "Google Cloud NS 2",
                "hint": "e.g. ns-cloud-a2.googledomains.com.",
                "default": "",
                "required": True,
            },
            "gcp_ns3": {
                "label": "Google Cloud NS 3",
                "hint": "e.g. ns-cloud-a3.googledomains.com.",
                "default": "",
                "required": True,
            },
            "gcp_ns4": {
                "label": "Google Cloud NS 4",
                "hint": "e.g. ns-cloud-a4.googledomains.com.",
                "default": "",
                "required": True,
            },
        },
    ...
    },
    {
        "id": "ns_hetzner",
        "name": "Hetzner DNS",
        "description": "NS records for Hetzner DNS Console",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
    ...
    {
        "id": "ns_linode",
        "name": "Linode (Akamai) DNS",
        "description": "NS records for Linode / Akamai Cloud DNS",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns1.linode.com."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns2.linode.com."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns3.linode.com."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns4.linode.com."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns5.linode.com."},
        ],
    },
    {
        "id": "ns_digitalocean",
        "name": "DigitalOcean DNS",
        "description": "NS records for DigitalOcean DNS",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
    ...
    },
    {
        "id": "ns_namecheap",
        "name": "Namecheap DNS",
        "description": "NS records for Namecheap BasicDNS / PremiumDNS",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
    ...
    },
    {
        "id": "ns_dynadot",
        "name": "Dynadot DNS",
        "description": "NS records for Dynadot DNS hosting",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns1.dynadot.com."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns2.dynadot.com."},
        ],
    },
    {
        "id": "ns_vultr",
        "name": "Vultr DNS",
        "description": "NS records for Vultr DNS",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns1.vultr.com."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns2.vultr.com."},
        ],
    },
    {
        "id": "ns_azure",
        "name": "Azure DNS",
        "description": "NS records for Azure DNS zone",
        "category": "DNS Providers",
        "variables": {
            "azure_ns1": {
                "label": "Azure NS 1",
                "hint": "From Azure DNS zone, e.g. ns1-01.azure-dns.com.",
                "default": "",
                "required": True,
            },
            "azure_ns2": {
                "label": "Azure NS 2",
                "hint": "e.g. ns2-01.azure-dns.net.",
                "default": "",
                "required": True,
            },
            "azure_ns3": {
                "label": "Azure NS 3",
                "hint": "e.g. ns3-01.azure-dns.org.",
                "default": "",
                "required": True,
            },
            "azure_ns4": {
                "label": "Azure NS 4",
                "hint": "e.g. ns4-01.azure-dns.info.",
                "default": "",
                "required": True,
            },
        },
    ...
    },
    {
        "id": "ns_ovh",
        "name": "OVH DNS",
        "description": "NS records for OVHcloud DNS",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "dns11.ovh.net."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns11.ovh.net."},
        ],
    },
    {
        "id": "ns_gandi",
        "name": "Gandi LiveDNS",
        "description": "NS records for Gandi LiveDNS",
        "category": "DNS Providers",
        "variables": {},
        "records": [
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns-107-a.gandi.net."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns-152-b.gandi.net."},
            {"type": "NS", "subname": "", "ttl": 3600,
             "content": "ns-210-c.gandi.net."},
        ],
    },
]
